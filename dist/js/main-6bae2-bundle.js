...
/** *** */ 	const __webpack_modules__ = ({
    ...
    /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      // CONCATENATED MODULE: ./js/Model/model.ts
      class Model {
        ...
        rightVal() {
          ...
          t.currentVal1 = Math.round(res * Math.pow(10, t.round)) / Math.pow(10, t.round);
      ...
      // CONCATENATED MODULE: ./js/Presenter/presenter.ts
      ...
      // CONCATENATED MODULE: ./js/Slider/slider.ts
      /* provided dependency */ const jQuery = __webpack_require__(638);
    ...
    /***/ (function (module, exports) {
      let __WEBPACK_AMD_DEFINE_ARRAY__; let
 ...
 */
  ...
  if (!support.attributes || !assert((el) => {
    ...
    addHandle('value', (elem, _name, isXML) => {
 ...
 */
  ...
  /** ********************************************************************* */
  (() => {
    /* provided dependency */ const $ = __webpack_require__(638);
