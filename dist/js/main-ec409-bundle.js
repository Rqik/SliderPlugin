...
;// CONCATENATED MODULE: ./MVP/View/Button/Butoon.ts
class Button {
  constructor() {
...
;// CONCATENATED MODULE: ./MVP/View/Interval/Interval.ts
class Interval {
  constructor() {
...
;// CONCATENATED MODULE: ./MVP/View/CurrentVal/CurrentVal.ts
class CurrentValue {
...
;// CONCATENATED MODULE: ./MVP/View/SliderRange/SliderRange.ts
class SliderRange {
  constructor(rot) {
...
;// CONCATENATED MODULE: ./MVP/EventObserver.ts
class EventObserver {
  constructor() {
    this.observers = [];
  }
...
;// CONCATENATED MODULE: ./MVP/View/View.ts
...
;// CONCATENATED MODULE: ./MVP/Model/Model.ts
...
class Model {
  ...
  step(position) {
    let percent = this.mathPercent(position);
...
;// CONCATENATED MODULE: ./MVP/Presenter/Presenter.ts
...
;// CONCATENATED MODULE: ./MVP/Slider/slider.ts
...
;// CONCATENATED MODULE: ./MVP/utils.ts
